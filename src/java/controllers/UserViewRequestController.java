 ...
 * @author Quoc Huy
 */
@WebServlet(name = "UserViewRequestController", urlPatterns = {"/UserViewRequestController"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (session != null) {
                ...
                List<RequestDTO> list = dao.UserSearch(content, userID, pageing);
            ...
            e.printStackTrace();
            log("Error at UserViewRequestController: " + e.getMessage());
        } finally {
